...
'LBL_MODULE_TITLE'=>'อีเมลล์: หน้าหลัก',
'LBL_SEARCH_FORM_TITLE'=>'ค้นหาอีเมลล์',
'LBL_LIST_FORM_TITLE'=>'แสดงอีเมลล์ทั้งหมด',
'LBL_NEW_FORM_TITLE'=>'ติดตามอีเมลล์',

'LBL_LIST_SUBJECT'=>'ชื่อเรื่อง',
'LBL_LIST_CONTACT'=>'ผู้ติดต่อ',
'LBL_LIST_RELATED_TO'=>'Related to',
'LBL_LIST_DATE'=>'วันส่ง',
'LBL_LIST_TIME'=>'เวลาส่ง',

'ERR_DELETE_RECORD'=>"A record number must be specified to delete the vtiger_account.",
'LBL_DATE_SENT'=>'วันส่ง:',
'LBL_DATE_AND_TIME'=>'วันเวลาส่ง:',
'LBL_DATE'=>'วันส่ง:',
'LBL_TIME'=>'เวลาส่ง:',
...
'LBL_COLON'=>':',
'LBL_CHK_MAIL'=>'เช็คอีเมลล์',
'LBL_COMPOSE'=>'เปรียบเทียบ',
//Single change for 5.0.3
'LBL_SETTINGS'=>'Incoming Mail Server Settings',
'LBL_EMAIL_FOLDERS'=>'Email Folders',
'LBL_INBOX'=>'ตู้จดหมาย',
'LBL_SENT_MAILS'=>'ส่งอีเมลล์',
'LBL_TRASH'=>'ถังขยะ',
'LBL_JUNK_MAILS'=>'อีเมลล์ขยะ',
